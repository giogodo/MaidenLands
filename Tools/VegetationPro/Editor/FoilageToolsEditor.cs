...
class GeoPaint
{
    ...
    public void OnEnable()
    {
        painter = GameObject.FindGameObjectWithTag("Foliage").GetComponent<GeoPainter>();
    ...
    public void DrawUI(EditorWindow window)
    {
        ...
        if (geoPaintUIFoldPanel)
        {
            ...
            if (GUILayout.Button(isPaintingButtonText))
            {
                ...
                {
                    objectsToScatter = FoilageToolsEditor.Instance.foilageGroupsEditor.groups.GetFoilageGroups();
                }
                else
                {
...
public class FoilageArea
{
    ...
    void MainPanel_UI()
    {
        ...
        if (mainfoldOut)
        {
            ...
            {
                generator.Distribute(FoilageToolsEditor.Instance.foilageGroupsEditor.groups);
    ...
    void GeneratePoints()
    {
        ...
        if (Selection.activeGameObject.GetComponent<Location_Tool.Location>())
            generator.GenerateInLocation(Selection.activeGameObject.GetComponent<Location_Tool.Location>());
        else
...
[System.Serializable]
public class FoilageToolsEditor : EditorWindow
{
    SceneView sceneView;
    static FoilageToolsEditor instance = null;
    public static FoilageToolsEditor Instance {
        get
        {
            return instance;
        }
    ...
    [MenuItem("MaidenLand Tools/Vegetation Tool_v1.0")]
    static void OpwnWindow()
    {
        FoilageToolsEditor window = (FoilageToolsEditor)GetWindow<FoilageToolsEditor>();
        // width, height
